...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderColor = typedArray.getColor(R.styleable.RoundImageView_border_color, Color.WHITE);
        mBorderWidth = typedArray.getDimension(R.styleable.RoundImageView_border_width, 0);
        mCornerRadius = typedArray.getDimension(R.styleable.RoundImageView_corner_radius, dp2px(10));
        mLeftTopCornerRadius = typedArray.getDimension(R.styleable.RoundImageView_leftTop_corner_radius, 0);
        mLeftBottomCornerRadius = typedArray.getDimension(R.styleable.RoundImageView_leftBottom_corner_radius, 0);
        mRightTopCornerRadius = typedArray.getDimension(R.styleable.RoundImageView_rightTop_corner_radius, 0);
        mRightBottomCornerRadius = typedArray.getDimension(R.styleable.RoundImageView_rightBottom_corner_radius, 0);
        mProgressColor = typedArray.getColor(R.styleable.RoundImageView_progress_color, Color.WHITE);
        mBorderProgress = typedArray.getInteger(R.styleable.RoundImageView_progress_border, 0);
        typedArray.recycle();
        init();
    }
