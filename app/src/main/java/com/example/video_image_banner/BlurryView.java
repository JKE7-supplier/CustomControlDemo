...
public class BlurryView extends View {
    ...
    private static final int DEFAULT_OVERLAY_COLOR = 0x55000000;
    private static final float DEFAULT_SCALE_FACTOR = 4;
    private static final float DEFAULT_BLURRY_RADIUS = 5;
    ...
    private ViewTreeObserver.OnPreDrawListener mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
        ...
        public boolean onPreDraw() {
            ...
            if (decor != null && isShown() && prepare()) {
                ...
                int xAxis = -locations[0];
                int yAxis = -locations[1];
                ...
                mBlurringCanvas.translate(-xAxis, -yAxis);
    ...
    private boolean prepare() {
        ...
        setRadius(radius);
        return createCanvas(scaleFactor);
    }

    private boolean createCanvas(float scaleFactor) {
        int width = getWidth();
